...
class SimpleTextSummarizer:
    ...
    def create_prompt(self, texts: List[str]) -> str:
        ...
        prompt = "You are modelling an expert at summarizing feedback."

        # # Add expert examples
        # for i, example in enumerate(self.expert_examples, 1):
        #     prompt += f"Example {i}:\n"
        ...
        prompt += "\nProvide a concise summary highlighting the key themes and insights:"
        return prompt
